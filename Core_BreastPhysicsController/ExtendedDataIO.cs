...
namespace BreastPhysicsController
{
    ...
    {
        private static readonly string ExtendedDataID_ver1 = "BreastDynamicBoneController";
        private static readonly string ExtendedDataKey_ver1 = "BrestDynamicBoneParameter";
