...
namespace BreastPhysicsController.UI
{
    public class ControllerWindow
    {
        ...
        private ParamCharaController _controller;
        ...
        private ToggleEnabled controllEnable;
        private CharaSelect charaSelect;
        private CoordinateSelect coordinateSelect;
        private SelectableButton<ParamCharaController.ParamsKind> kindSelect;

        //GUI Component(per WearState)
        private EditorBust editorBust;
        private EditorHip editorHip;
        ...
        private readonly int _toolsWindowId;

        //GUI Style
        private GUIStyle styleMatchState;
