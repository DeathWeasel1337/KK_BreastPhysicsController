    ...
    public class EditorHip
    {
        ...
        public bool Draw(ParamCharaController controller)
        {
            ...
            */
            ...
            if (changedEnabled)
            {
                controller.changedInfo.SetInfo(DefaultCoordinateType, ParamCharaController.ParamsKind.Hip, true, false);
            }
            else if (changedParams)
            {
                controller.changedInfo.SetInfo(DefaultCoordinateType, ParamCharaController.ParamsKind.Hip, false, true);
            }
