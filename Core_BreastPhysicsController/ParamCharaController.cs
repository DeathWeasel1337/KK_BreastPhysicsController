...
namespace BreastPhysicsController
{
    ...
    {
        public static readonly string ExtendedDataKey = "DynamicBoneParameter";
        ...
        private bool endInitLoad;
#if KK
        private const ChaFileDefine.CoordinateType DefaultCoordinateType = ChaFileDefine.CoordinateType.School01;
#else
        private const ChaFileDefine.CoordinateType DefaultCoordinateType = ChaFileDefine.CoordinateType.Plain;
#endif

        private void Init()
        {
            controllerID = GetInstanceID();
        ...
        private bool IsMatchState(ParamsKind paramsKind, ChaFileDefine.CoordinateType coordinate = DefaultCoordinateType)
        {
            switch (paramsKind)
            {
        ...
        public bool LoadParamFromChara(ChaFileDefine.CoordinateType coordinate, ParamsKind paramsKind)
        {
            ...
            changedInfo.SetInfo(coordinate, paramsKind, false, true, true);
        ...
        {
            if (!LoadParamFromChara(DefaultCoordinateType, ParamsKind.Naked)) return false;
            ...
            if (!LoadParamFromChara(DefaultCoordinateType, ParamsKind.Hip)) return false;

            changedInfo.SetInfo(DefaultCoordinateType, ParamsKind.Naked, true, true, true);
        ...
        public void ChangeEnabledAll(bool enabled)
        {
            ...
            changedInfo.SetInfo(DefaultCoordinateType, ParamsKind.Naked, true, false, true);
        }
        ...
        public void CopyParamAllCoordinate(ChaFileDefine.CoordinateType srcCoordinate)
        {
            ...
            changedInfo.SetInfo(DefaultCoordinateType, ParamsKind.Naked, false, true, true);
        }
